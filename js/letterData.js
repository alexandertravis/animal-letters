...
(function (APP) {
  ...
  // ── Digits 0–9 ─────────────────────────────────────────────────────────────
  LETTERS['0'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 100,31 C 135,31 155,60 155,100 C 155,140 135,169 100,169 C 65,169 45,140 45,100 C 45,60 65,31 100,31' }
  ]};
  LETTERS['1'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 72,58 L 100,31' },
    { d: 'M 100,31 L 100,169' }
  ]};
  LETTERS['2'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 55,65 C 55,40 145,35 145,80 C 145,115 60,145 50,169 L 150,169' }
  ]};
  LETTERS['3'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 55,45 C 100,31 155,50 155,90 C 155,115 125,120 100,120 C 125,120 158,130 158,155 C 158,185 110,175 55,160' }
  ]};
  LETTERS['4'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 130,169 L 130,31 L 40,135 L 158,135' }
  ]};
  LETTERS['5'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 148,31 L 58,31 L 50,110 C 65,96 85,92 100,92 C 135,92 155,115 155,140 C 155,165 135,175 105,175 C 80,175 58,162 50,148' }
  ]};
  LETTERS['6'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 140,45 C 110,28 48,50 45,110 C 43,155 65,175 100,175 C 135,175 155,155 155,135 C 155,110 135,95 100,95 C 65,95 45,115 45,135' }
  ]};
  LETTERS['7'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 48,31 L 152,31 L 85,169' }
  ]};
  LETTERS['8'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 100,31 C 65,31 50,50 50,75 C 50,100 70,115 100,120 C 130,125 155,140 155,160 C 155,180 135,175 100,175 C 65,175 45,165 45,145 C 45,125 70,120 100,120 C 130,115 150,100 150,75 C 150,50 135,31 100,31' }
  ]};
  LETTERS['9'] = { viewBox: '0 0 200 220', coords: 'display', strokes: [
    { d: 'M 155,85 C 155,55 135,31 100,31 C 65,31 45,55 45,85 C 45,115 65,135 100,135 C 135,135 155,115 155,85 C 155,115 145,155 105,169' }
  ]};
