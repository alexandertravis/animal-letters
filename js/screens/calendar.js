...
// Days & Months — stub for Section 1; full game arrives in Section 2.
(function (APP) {
  function render(root, ctx) {
    root.innerHTML = '';
    var wrap = document.createElement('div');
    wrap.style.cssText = 'display:flex;flex-direction:column;min-height:100vh;';
    wrap.appendChild(APP.ui.topbar({ ctx: ctx, title: APP.t('game.calendar.title') || 'Days & Months', home: true, back: true }));
