...
// Starting Letter — stub for Section 1; full game arrives in Section 3.
(function (APP) {
  function render(root, ctx) {
    root.innerHTML = '';
    var wrap = document.createElement('div');
    wrap.style.cssText = 'display:flex;flex-direction:column;min-height:100vh;';
    wrap.appendChild(APP.ui.topbar({ ctx: ctx, title: APP.t('game.firstletter.title') || 'Starting Letter', home: true, back: true }));
    ...
    body.innerHTML = '<div style="font-size:4rem">🅰️</div><div style="font-size:1.1rem;color:#667">' + (APP.t('ui.comingSoon') || 'Coming soon!') + '</div>';
