...
// "What plants need" — stub for Section 1; full mini-game arrives in Section 3.
(function (APP) {
  function render(root, ctx) {
    ...
    wrap.appendChild(APP.ui.topbar({
      ctx: ctx,
      title: APP.t('game.plantneeds.title') || 'What Plants Need',
      home: true,
      back: true
    }));
    ...
    body.innerHTML = '<div style="font-size:4rem">💧</div><div style="font-size:1.1rem;color:#667">' +
      (APP.t('ui.comingSoon') || 'Coming soon!') + '</div>';
