...
(function(APP) {
  var BUILDINGS = {
    ...
    clock: '<svg viewBox="0 0 120 110"><rect x="42" y="30" width="36" height="75" fill="#b8a0d8"/><polygon points="60,8 38,30 82,30" fill="#7a5ea8"/><rect x="30" y="100" width="60" height="6" fill="#7a5ea8"/><circle cx="60" cy="52" r="17" fill="#fffdf5" stroke="#3a4a6b" stroke-width="3"/><line x1="60" y1="52" x2="60" y2="42" stroke="#3a4a6b" stroke-width="2.5" stroke-linecap="round"/><line x1="60" y1="52" x2="68" y2="55" stroke="#e06666" stroke-width="2" stroke-linecap="round"/><circle cx="60" cy="52" r="2.2" fill="#3a4a6b"/><rect x="51" y="80" width="18" height="20" rx="3" fill="#7a5ea8"/></svg>',
    humanbody: '<svg viewBox="0 0 120 110"><rect x="18" y="42" width="84" height="63" fill="#ffd1dc"/><polygon points="60,10 14,44 106,44" fill="#e26d8a"/><rect x="26" y="54" width="16" height="15" rx="2" fill="#fff"/><rect x="78" y="54" width="16" height="15" rx="2" fill="#fff"/><path d="M60,99 C42,84 34,76 34,66 C34,59 39,55 45,55 C51,55 56,60 60,65 C64,60 69,55 75,55 C81,55 86,59 86,66 C86,76 78,84 60,99 Z" fill="#e63950"/><rect x="56" y="66" width="8" height="22" rx="2" fill="#fff"/><rect x="49" y="73" width="22" height="8" rx="2" fill="#fff"/></svg>',
    space: '<svg viewBox="0 0 120 110"><rect x="0" y="99" width="120" height="7" fill="#3a2a5c"/><circle cx="18" cy="22" r="2" fill="#fff"/><circle cx="100" cy="28" r="2.5" fill="#fff"/><circle cx="92" cy="14" r="1.6" fill="#fff"/><circle cx="28" cy="40" r="1.6" fill="#fff"/><path d="M60,14 C74,30 78,56 78,78 L42,78 C42,56 46,30 60,14 Z" fill="#e8edf7" stroke="#b0bcd8" stroke-width="2"/><circle cx="60" cy="46" r="9" fill="#7ec8e3" stroke="#3a7ca5" stroke-width="2"/><path d="M42,72 L30,92 L42,84 Z" fill="#ef476f"/><path d="M78,72 L90,92 L78,84 Z" fill="#ef476f"/><rect x="52" y="78" width="16" height="7" fill="#b0bcd8"/><path d="M54,85 C56,98 64,98 66,85 Z" fill="#ffb302"/></svg>',
  };
